...
Route::middleware(['auth:sanctum', 'verified'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('permission:edit company profile')->group(function () {
        Route::get('/company-profile', [AdminController::class, 'companyProfile'])->name('company-profile');
        Route::get('/company-profile/edit', [AdminController::class, 'editCompanyProfile'])->name('company-profile.edit');
        Route::put('/company-profile', [AdminController::class, 'updateCompanyProfile'])->name('company-profile.update');
    });
