@props([
    'src', 'fallback', 'alt', 'title', 'desc', 'buttonLabel' => null
])

<div class="rounded-lg overflow-hidden bg-white text-neutral-700 w-[270px] flex flex-col items-center mx-auto mb-8 {{ $buttonLabel ? 'border-2 border-gray-800 h-[420px] shadow-xl' : 'h-[360px] shadow' }}">
